...
CONTAINER_CMD="cargo build --bin refbox --bin beep-test --target x86_64-pc-windows-msvc --release"
CONTAINER_WORKDIR="/workdir"

CONTAINER_NAME="$(docker create -t -w "$CONTAINER_WORKDIR/" windows-rust-1.82-xc /bin/bash -c "$CONTAINER_CMD")"
