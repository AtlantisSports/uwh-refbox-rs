...
custom-site-invalid =
    Hindi magagamit ang address na ito. Dapat itong kagaya ng:
...
gi-half-length = Haba ng Kalahati
gi-half-time-length = Haba ng Pahinga sa Kalahati
gi-game-length = Haba ng Laro
gi-timeouts = Mga Timeout
gi-timeout-duration = Tagal ng Timeout
gi-overtime = Overtime
gi-sudden-death = Sudden Death
gi-pre-overtime-break = Pahinga Bago Overtime
gi-pre-sudden-death-break = Pahinga Bago Sudden Death
gi-overtime-half-length = Haba ng Kalahati sa Overtime
gi-overtime-half-time-length = Haba ng Pahinga sa Overtime
gi-minimum-game-break = Pinakamaliit na Oras sa Pagitan ng mga Laro
gi-stop-clock-last-2 = Ihinto ang Orasan sa Huling 2 Minuto
gi-ref-chief = Punong Referee
gi-ref-timekeeper = Tagapanatili ng Oras/Puntos
gi-ref-timekeeper-helper = Katulong na Tagapanatili ng Oras/Puntos
