...
show-countdown-for-last-10-seconds = TAMPILKAN HITUNG
    MUNDUR 10 DETIK
audible-countdown-for-last-10-seconds = HITUNG MUNDUR SUARA
    10 DETIK
delay = TERLAMBAT
court = LAPANGAN:
single-half = BABAK
...
updates-install-note = Mengeklik Pasang akan mengunduh dan memasang pembaruan lalu memulai ulang refbox
updates-revert-note = Mengeklik Kembalikan akan memulihkan versi sebelumnya dan memulai ulang refbox
...
updates-rolled-back = Dikembalikan ke versi sebelumnya karena pembaruan tidak dimulai dengan benar, silakan coba lagi.
...
gi-half-length = Durasi Babak
gi-half-time-length = Durasi Jeda Babak
gi-game-length = Durasi Pertandingan
gi-timeouts = Time-out
gi-timeout-duration = Durasi Time-out
gi-overtime = Perpanjangan Waktu
gi-sudden-death = Sudden Death
gi-pre-sudden-death-break = Durasi Jeda Sebelum Sudden Death
gi-pre-overtime-break = Durasi Jeda Sebelum Perpanjangan Waktu
gi-overtime-half-length = Durasi Babak Perpanjangan Waktu
gi-overtime-half-time-length = Durasi Jeda Perpanjangan Waktu
gi-minimum-game-break = Waktu Minimum Antar Pertandingan
gi-stop-clock-last-2 = Hentikan Jam di 2 Menit Terakhir
gi-ref-chief = Wasit Kepala
gi-ref-timekeeper = Pencatat Waktu
gi-ref-timekeeper-helper = Asisten Pencatat Waktu
