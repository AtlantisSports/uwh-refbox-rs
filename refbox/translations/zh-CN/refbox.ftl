...
gi-game-block = 比赛块
gi-half-length = 半场时长
gi-half-time-length = 中场时长
gi-game-length = 比赛时长
gi-timeouts = 暂停
gi-timeout-duration = 暂停时长
gi-overtime = 加时赛
gi-sudden-death = 突然死亡
gi-pre-overtime-break = 加时前休息
gi-pre-sudden-death-break = 突然死亡前休息
gi-overtime-half-length = 加时赛半场时长
gi-overtime-half-time-length = 加时赛中场时长
gi-minimum-game-break = 最短场间时间
gi-stop-clock-last-2 = 最后2分钟停钟
gi-ref-chief = 主裁判
gi-ref-timekeeper = 计时员
gi-ref-timekeeper-helper = 计时助理员
gi-ref-water-1 = 水下裁判1
gi-ref-water-2 = 水下裁判2
gi-ref-water-3 = 水下裁判3
gi-unknown = ???
