...
portal-page-title-attention = Juego { $game } · Error al enviar resultado
...
portal-page-attention-info = Probablemente debido a un error de conexión, el resultado del juego no ha sido aceptado por el UWH Portal
