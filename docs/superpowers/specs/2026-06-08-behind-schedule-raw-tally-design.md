> **SUPERSEDED on 2026-09-11.** The raw deviation tally this document specifies has been retired
> from the engine entirely -- it fed nothing but the display -- and `behind_schedule_shown` with it.
>
