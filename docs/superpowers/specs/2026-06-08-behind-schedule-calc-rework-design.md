> **SUPERSEDED on 2026-09-11.** The directly-measured `regulation_played` accumulator and the
> whole calculation described below were removed, along with the clawback buffer.
>
