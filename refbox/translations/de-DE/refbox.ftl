...
revive-hold-line-1 = HALTEN ZUM
revive-hold-line-2 = WIEDERHERST.
revive-deciding-line-2 = WIEDERHERGEST.
...
gi-prior-game = Letztes Spiel
gi-team-light = { -light-team-name }
gi-team-dark = { -dark-team-name }
gi-current-game = Aktuelles Spiel
gi-next-game = Nächstes Spiel
gi-game-block = Spielblock
gi-half-length = Halbzeitdauer
gi-half-time-length = Halbzeitpausendauer
gi-game-length = Spieldauer
gi-timeouts = Auszeiten
gi-timeout-duration = Auszeit-Dauer
gi-overtime = Verlängerung
gi-sudden-death = Plötzlicher Tod
gi-pre-overtime-break = Pause vor Verlängerung
gi-pre-sudden-death-break = Pause vor Plötzlichem Tod
gi-overtime-half-length = Halbzeitdauer Verlängerung
gi-overtime-half-time-length = Halbzeitpausendauer Verlängerung
gi-minimum-game-break = Minimale Spielpause
gi-stop-clock-last-2 = Uhr in den letzten 2 Minuten stoppen
gi-ref-chief = Hauptschiedsrichter
gi-ref-timekeeper = Zeitnehmer
gi-ref-timekeeper-helper = Zeitnehmer-Assistent
gi-ref-water-1 = Wasserschiedsrichter 1
gi-ref-water-2 = Wasserschiedsrichter 2
gi-ref-water-3 = Wasserschiedsrichter 3
gi-ref-water-referees = Wasserschiedsrichter
gi-ref-deck-referees = Deckschiedsrichter
gi-unknown = ???

shut-down = HERUNTERFAHREN
restart-pi = PI NEU STARTEN
restart-refbox = REFBOX NEU STARTEN
